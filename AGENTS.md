...
This file is the entry point for LLM coding agents working in this repository. All detailed instructions are split into topic-specific documents located in the `/docs` directory. Read the relevant document(s) before making any changes.
